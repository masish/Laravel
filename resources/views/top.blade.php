            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-xs-4">
                        <div class="top-number"><p><i class="fa fa-phone-square"></i>  0558-62-0093</p></div>
                    </div>
                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">いしい林業は今年で7年目を迎えました。</h1>
                                    <h2 class="animation animated-item-2">私たち「いしい林業」は地元伊豆で、間伐、植栽などの山林管理をしています...</h2>
                                    <a class="btn-slide animation animated-item-3" href="#">もっと読む</a>
                                </div>
                            </div>
